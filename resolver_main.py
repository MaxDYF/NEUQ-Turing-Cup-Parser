...
with open("./data/resolver.json", 'w', encoding='utf-8') as ff:
    ...
    resultDict['FLOAT_POINT_EXCEPTION']='RE'
    ...
    for j in range(0,len(contestRun)):
        ...
        submissionData['time']=convert_ms_to_isoformat(config['start_time'] * 1000 +v['timestamp'])
        ...
        judgementData['start_time']=convert_ms_to_isoformat(config['start_time'] * 1000 +v['timestamp'])
